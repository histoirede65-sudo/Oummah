            ...
            <View style={styles.pathCard}>
              ...
              {pathLocked ? (
                <View style={styles.pathLockedBox}>
                  ...
                  <Pressable onPress={() => router.push("/profile")} style={styles.pathLockedButton}>
...
const styles = StyleSheet.create({
  ...
  headerCopy: { flex: 1, minWidth: 0, marginHorizontal: 12 }, headerTitle: { color: colors.text, fontFamily: typography.serifSemibold, fontSize: 21 }, headerSubtitle: { marginTop: 1, color: colors.textMuted, fontFamily: typography.sans, fontSize: 9.5 },
  ...
  pathBadgeText: { marginLeft: 5, color: colors.goldLight, fontFamily: typography.sans, fontSize: 7.5, fontWeight: "800", letterSpacing: 0.8 },
  pathMeta: { color: colors.textMuted, fontFamily: typography.sans, fontSize: 9 },
  pathTitle: { marginTop: 12, color: colors.text, fontFamily: typography.serifSemibold, fontSize: 18 },
  pathSubtitle: { marginTop: 7, color: colors.goldLight, fontFamily: typography.serifMedium, fontSize: 13 },
  pathDescription: { marginTop: 5, color: colors.textSecondary, fontFamily: typography.sans, fontSize: 9.5, lineHeight: 15 },
  ...
  pathLockedTitle: { color: colors.goldLight, fontFamily: typography.sans, fontSize: 9.5, fontWeight: "800" },
  pathLockedText: { marginTop: 2, color: colors.textMuted, fontFamily: typography.sans, fontSize: 8.5, lineHeight: 12.5 },
  ...
  pathLockedButtonText: { color: colors.background, fontFamily: typography.sans, fontSize: 8.5, fontWeight: "800" },
  ...
  pathSecondaryText: { color: colors.textSecondary, fontFamily: typography.sans, fontSize: 9, fontWeight: "700" },
  pathPrimary: { minHeight: 40, flex: 1, alignItems: "center", justifyContent: "center", borderRadius: 13, backgroundColor: colors.goldLight },
  pathPrimaryText: { color: colors.background, fontFamily: typography.sans, fontSize: 9, fontWeight: "800" },
  sectionLabel: { marginTop: 19, marginBottom: 8, color: colors.goldMuted, fontFamily: typography.sans, fontSize: 8, fontWeight: "800", letterSpacing: 1.05 },
  sectionHeading: { marginTop: 22, marginBottom: 9, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, sectionTitle: { color: colors.text, fontFamily: typography.serifSemibold, fontSize: 20 }, sectionMeta: { color: colors.textMuted, fontFamily: typography.sans, fontSize: 9.5 },
  goals: { gap: 8 }, addButton: { minHeight: 48, marginTop: 10, flexDirection: "row", alignItems: "center", justifyContent: "center", borderRadius: 17, borderWidth: 1, borderStyle: "dashed", borderColor: "rgba(241,188,79,0.30)" }, addText: { marginLeft: 7, color: colors.goldLight, fontFamily: typography.sans, fontSize: 11, fontWeight: "700" },
  footerNote: { marginTop: 15, color: colors.textMuted, fontFamily: typography.serifMedium, fontSize: 9.5, lineHeight: 15, textAlign: "center" },
  eveningCard: { minHeight: 92, marginTop: 10, padding: 13, flexDirection: "row", alignItems: "center", borderRadius: 20, borderWidth: 1, borderColor: "rgba(241,188,79,0.13)", backgroundColor: "rgba(74,40,88,0.16)" }, eveningIcon: { width: 39, height: 39, alignItems: "center", justifyContent: "center", borderRadius: 14, backgroundColor: "rgba(241,188,79,0.08)" }, eveningCopy: { flex: 1, minWidth: 0, marginLeft: 11 }, eveningEyebrow: { color: colors.goldMuted, fontFamily: typography.sans, fontSize: 7.5, fontWeight: "800", letterSpacing: 0.9 }, eveningTitle: { marginTop: 4, color: colors.text, fontFamily: typography.serifMedium, fontSize: 13 }, eveningText: { marginTop: 4, color: colors.textMuted, fontFamily: typography.sans, fontSize: 9.2, lineHeight: 14 },
  ...
  modalEyebrow: { color: colors.goldMuted, fontFamily: typography.sans, fontSize: 8, fontWeight: "800", letterSpacing: 1.1 }, modalTitle: { marginTop: 4, color: colors.text, fontFamily: typography.serifSemibold, fontSize: 23 }, modalText: { marginTop: 7, color: colors.textSecondary, fontFamily: typography.sans, fontSize: 11, lineHeight: 17 },
  input: { height: 50, marginTop: 17, paddingHorizontal: 14, borderRadius: 16, borderWidth: 1, borderColor: "rgba(255,255,255,0.10)", backgroundColor: "rgba(255,255,255,0.04)", color: colors.text, fontFamily: typography.sans, fontSize: 13 }, modalActions: { marginTop: 15, flexDirection: "row", gap: 8 },
  secondaryButton: { minHeight: 46, flex: 1, alignItems: "center", justifyContent: "center", borderRadius: 15, backgroundColor: "rgba(255,255,255,0.06)" }, secondaryText: { color: colors.textSecondary, fontFamily: typography.sans, fontSize: 11, fontWeight: "700" }, primaryButton: { minHeight: 46, flex: 1, alignItems: "center", justifyContent: "center", borderRadius: 15, backgroundColor: colors.goldLight }, primaryText: { color: colors.background, fontFamily: typography.sans, fontSize: 11, fontWeight: "800" },
  settingsSheet: { paddingTop: 10, paddingHorizontal: 20, paddingBottom: 26, borderRadius: 28, borderWidth: 1, borderColor: "rgba(241,188,79,0.20)", backgroundColor: colors.backgroundSecondary }, handle: { width: 42, height: 4, marginBottom: 18, alignSelf: "center", borderRadius: 2, backgroundColor: "rgba(255,255,255,0.18)" }, paces: { marginTop: 18, flexDirection: "row", gap: 7 }, pace: { height: 65, flex: 1, alignItems: "center", justifyContent: "center", borderRadius: 17, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", backgroundColor: "rgba(255,255,255,0.035)" }, paceActive: { borderColor: colors.goldLight, backgroundColor: "rgba(241,188,79,0.11)" }, paceValue: { color: colors.textSecondary, fontFamily: typography.serifSemibold, fontSize: 20 }, paceValueActive: { color: colors.goldLight }, paceLabel: { marginTop: 1, color: colors.textMuted, fontFamily: typography.sans, fontSize: 7, fontWeight: "800" }, paceLabelActive: { color: colors.goldMuted }, calmNote: { marginTop: 15, color: colors.textMuted, fontFamily: typography.sans, fontSize: 9.5, lineHeight: 15 }, primaryButtonWide: { minHeight: 48, marginTop: 17, alignItems: "center", justifyContent: "center", borderRadius: 16, backgroundColor: colors.goldLight },
  focusTitle: { marginTop: 19, marginBottom: 9, color: colors.textSecondary, fontFamily: typography.serifMedium, fontSize: 14 }, focuses: { flexDirection: "row", flexWrap: "wrap", gap: 7 }, focus: { minHeight: 38, paddingHorizontal: 11, flexDirection: "row", alignItems: "center", borderRadius: 13, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", backgroundColor: "rgba(255,255,255,0.03)" }, focusActive: { borderColor: "rgba(241,188,79,0.42)", backgroundColor: "rgba(241,188,79,0.09)" }, focusText: { marginLeft: 6, color: colors.textMuted, fontFamily: typography.sans, fontSize: 9.5, fontWeight: "700" }, focusTextActive: { color: colors.goldLight },
});
