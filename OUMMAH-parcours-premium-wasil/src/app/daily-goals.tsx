...
export default function DailyGoalsScreen() {
  ...
  useEffect(() => {
    void Promise.all([goalRepository.readSettings(), goalRepository.recent(), progressivePathRepository.getActive()]).then(
      ([storedSettings, plans, activePath]) => {
