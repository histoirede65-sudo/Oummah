...
export const HADITH_COLLECTIONS: readonly HadithCollection[] = [
  { id: "bukhari", name: "Sahih al-Bukhari", arabicName: "صحيح البخاري", description: "Hadiths référencés dans le recueil de l’imam al-Bukhari.", query: "al-Bukhari", queryAliases: ["Al-Bukhârî", "Bukhari"], tone: "#A87245", availability: "selection" },
  ...
  { id: "abu-dawud", name: "Sunan Abu Dawud", arabicName: "سنن أبي داود", description: "Sélection issue des Sunan d’Abu Dawud.", query: "Abû Dâwud", queryAliases: ["Abu Dawud", "Abou Daoud"], tone: "#6E628A", availability: "selection" },
  { id: "tirmidhi", name: "Jami‘ at-Tirmidhi", arabicName: "جامع الترمذي", description: "Sélection référencée du Jami‘ at-Tirmidhi.", query: "At-Tirmidhî", queryAliases: ["Tirmidhi", "At-Tirmidhi"], tone: "#977452", availability: "selection" },
  { id: "nasai", name: "Sunan an-Nasa’i", arabicName: "سنن النسائي", description: "Sélection référencée des Sunan an-Nasa’i.", query: "An-Nasâ'î", queryAliases: ["Nasa'i", "Nasai"], tone: "#47717F", availability: "selection" },
