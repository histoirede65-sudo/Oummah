...
function ReciterGalleryCard({
  ...
  useEffect(() => {
    ...
    const animation = Animated.sequence([
      Animated.parallel([
        ...
        Animated.timing(favoriteRotation, {
          toValue: 1,
          duration: 100,
          useNativeDriver: true,
        }),
    ...
    animation.start(() => {
      if (favoriteAnimation.current === animation)
        favoriteAnimation.current = null;
    });
  ...
  return (
    <Reanimated.View
      style={[styles.card, selected && styles.preferredCard, cardPressStyle]}
    >
      <LinearGradient
        pointerEvents="none"
      ...
      >
        <View style={styles.portrait}>
          {reciter.image ? (
            ...
            <LinearGradient
              colors={[colors.purpleMid, colors.backgroundSecondary]}
          ...
          <LinearGradient
            colors={["transparent", "rgba(8,7,19,0.92)"]}
            style={StyleSheet.absoluteFill}
          />
      ...
      <AnimatedPressable
        ...
        style={[
          styles.favorite,
          selected && styles.favoriteActive,
          { transform: [{ scale: favoriteScale }, { rotate: favoriteRotate }] },
        ]}
      >
        <Ionicons
      ...
      {onPlay ? (
        <Pressable
          ...
          style={({ pressed }) => [styles.quickPlay, pressed && styles.pressed]}
        >
